...
<body class="d-flex flex-column h-100">
    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Panggilan Antrian Taksi Bandara Hang Nadim - Batam</h1>
        </div>
        <!-- breadcrumbs -->
      ...
      <div class="row">
        <!-- menampilkan informasi jumlah antrian --><!-- menampilkan informasi nomor antrian yang sedang dipanggil -->
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0">Antrian Taksi Konvensional Sekarang</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  <p id="antrian-sekarang" class="fs-3 text-success mb-1"></p>
                  <p class="mb-0">Antrian Taksi Online Sekarang</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- Muhammad Ridho Purwono -->
  <!-- <script src="https://code.responsivevoice.org/responsivevoice.js?key=wdiqIkI7"></script>  -->
  <!-- ori -->
