  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Sistem Antrian Taksi Bandara Hang Nadim Batam</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>Nomor Antrian Taksi</h3>
              <p class="mb-4">Halaman Nomor Antrian digunakan pengunjung untuk mengambil nomor antrian taksi.</p>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="https://supportsystemindonesia.com/" target="_blank" class="text-danger text-decoration-none">www.supportsystemindonesia.com</a>. All rights reserved.
      </div>
    </div>
  </footer>
